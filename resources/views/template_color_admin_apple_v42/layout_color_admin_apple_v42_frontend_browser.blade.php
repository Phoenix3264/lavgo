...
<body data-spy="scroll" data-target="#header" data-offset="51">
	...
	<div id="page-container" class="fade">
		...
		<div id="home" class="content has-bg home">
			<!-- begin content-bg -->
			<div class="content-bg" style="background-image: url({{ asset('/public/').'/'.$root }}/assets/img/bg/bg-home.jpg);" 
				data-paroller="true" 
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-12">
						...
						<div class="about-author">
							...
							<div class="author">
								<div class="image">
									<img src="{{ asset('/public/').'/'.$root }}/assets/img/user/user-1.jpg" alt="Sean Ngu" />
								</div>
								<div class="info">
									Sean Ngu
		...
		<div id="milestone" class="content bg-black-darker has-bg" data-scrollview="true">
			<!-- begin content-bg -->
			<div class="content-bg" style="background-image: url({{ asset('/public/').'/'.$root }}/assets/img/bg/bg-milestone.jpg)"
				data-paroller="true" 
				data-paroller-factor="0.5"
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-12">
						...
						<div class="team">
							<div class="image" data-animation="true" data-animation-type="flipInX">
								<img src="{{ asset('/public/').'/'.$root }}/assets/img/user/user-1.jpg" alt="Ryan Teller" />
							</div>
							<div class="info">
					...
					<div class="col-md-4 col-sm-12">
						...
						<div class="team">
							<div class="image" data-animation="true" data-animation-type="flipInX">
								<img src="{{ asset('/public/').'/'.$root }}/assets/img/user/user-2.jpg" alt="Jonny Cash" />
							</div>
							<div class="info">
					...
					<div class="col-md-4 col-sm-12">
						...
						<div class="team">
							<div class="image" data-animation="true" data-animation-type="flipInX">
								<img src="{{ asset('/public/').'/'.$root }}/assets/img/user/user-3.jpg" alt="Mia Donovan" />
							</div>
							<div class="info">
		...
		<div id="quote" class="content bg-black-darker has-bg" data-scrollview="true">
			<!-- begin content-bg -->
			<div class="content-bg" style="background-image: url({{ asset('/public/').'/'.$root }}/assets/img/bg/bg-quote.jpg)"
				data-paroller-factor="0.5"
				data-paroller-factor-md="0.01"
		...
		<div id="action-box" class="content has-bg" data-scrollview="true">
			<!-- begin content-bg -->
			<div class="content-bg" style="background-image: url({{ asset('/public/').'/'.$root }}/assets/img/bg/bg-action.jpg)"
				data-paroller-factor="0.5"
				data-paroller-factor-md="0.01"
				data-paroller-factor-xs="0.01">
			</div>
			...
			<div class="container" data-animation="true" data-animation-type="fadeInDown">
				...
				<div class="row row-space-10">
					...
					<div class="col-md-3 col-sm-6">
						...
						<div class="work">
							<div class="image">
								<a href="#"><img src="{{ asset('/public/').'/'.$root }}/assets/img/work/work-img-1.jpg" alt="Work 1" /></a>
							</div>
							<div class="desc">
					...
					<div class="col-md-3 col-sm-6">
						...
						<div class="work">
							<div class="image">
								<a href="#"><img src="{{ asset('/public/').'/'.$root }}/assets/img/work/work-img-2.jpg" alt="Work 2" /></a>
							</div>
							<div class="desc">
					...
					<div class="col-md-3 col-sm-6">
						...
						<div class="work">
							<div class="image">
								<a href="#"><img src="{{ asset('/public/').'/'.$root }}/assets/img/work/work-img-3.jpg" alt="Work 3" /></a>
							</div>
							<div class="desc">
					...
					<div class="col-md-3 col-sm-6">
						...
						<div class="work">
							<div class="image">
								<a href="#"><img src="{{ asset('/public/').'/'.$root }}/assets/img/work/work-img-4.jpg" alt="Work 4" /></a>
							</div>
							<div class="desc">
				...
				<div class="row row-space-10">
					...
					<div class="col-md-3 col-sm-6">
						...
						<div class="work">
							<div class="image">
								<a href="#"><img src="{{ asset('/public/').'/'.$root }}/assets/img/work/work-img-5.jpg" alt="Work 5" /></a>
							</div>
							<div class="desc">
					...
					<div class="col-md-3 col-sm-6">
						...
						<div class="work">
							<div class="image">
								<a href="#"><img src="{{ asset('/public/').'/'.$root }}/assets/img/work/work-img-6.jpg" alt="Work 6" /></a>
							</div>
							<div class="desc">
					...
					<div class="col-md-3 col-sm-6">
						...
						<div class="work">
							<div class="image">
								<a href="#"><img src="{{ asset('/public/').'/'.$root }}/assets/img/work/work-img-7.jpg" alt="Work 7" /></a>
							</div>
							<div class="desc">
					...
					<div class="col-md-3 col-sm-6">
						...
						<div class="work">
							<div class="image">
								<a href="#"><img src="{{ asset('/public/').'/'.$root }}/assets/img/work/work-img-8.jpg" alt="Work 8" /></a>
							</div>
							<div class="desc">
		...
		<div id="client" class="content has-bg bg-green" data-scrollview="true">
			<!-- begin content-bg -->
			<div class="content-bg" style="background-image: url({{ asset('/public/').'/'.$root }}/assets/img/bg/bg-client.jpg)"
				data-paroller-factor="0.5"
				data-paroller-factor-md="0.01"
				data-paroller-factor-xs="0.01">
			</div>
		...
		<div class="theme-panel">
			...
			<div class="theme-panel-content">
				<ul class="theme-list clearfix">
					<li><a href="javascript:;" class="bg-red" data-theme="red" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/red.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Red" data-original-title="" title="">&nbsp;</a></li>
					<li><a href="javascript:;" class="bg-pink" data-theme="pink" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/pink.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Pink" data-original-title="" title="">&nbsp;</a></li>
					<li><a href="javascript:;" class="bg-orange" data-theme="orange" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/orange.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Orange" data-original-title="" title="">&nbsp;</a></li>
					<li><a href="javascript:;" class="bg-yellow" data-theme="yellow" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/yellow.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Yellow" data-original-title="" title="">&nbsp;</a></li>
					<li><a href="javascript:;" class="bg-lime" data-theme="lime" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/lime.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Lime" data-original-title="" title="">&nbsp;</a></li>
					<li><a href="javascript:;" class="bg-green" data-theme="green" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/green.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Green" data-original-title="" title="">&nbsp;</a></li>
					<li class="active"><a href="javascript:;" class="bg-teal" data-theme="default" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/default.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Default" data-original-title="" title="">&nbsp;</a></li>
					<li><a href="javascript:;" class="bg-aqua" data-theme="aqua" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/aqua.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Aqua" data-original-title="" title="">&nbsp;</a></li>
					<li><a href="javascript:;" class="bg-blue" data-theme="blue" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/blue.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Blue" data-original-title="" title="">&nbsp;</a></li>
					<li><a href="javascript:;" class="bg-purple" data-theme="purple" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/purple.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Purple" data-original-title="" title="">&nbsp;</a></li>
					<li><a href="javascript:;" class="bg-indigo" data-theme="indigo" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/indigo.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Indigo" data-original-title="" title="">&nbsp;</a></li>
					<li><a href="javascript:;" class="bg-black" data-theme="black" data-theme-file="{{ asset('/public/').'/'.$root }}/assets/css/one-page-parallax/theme/black.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Black" data-original-title="" title="">&nbsp;</a></li>
				</ul>
			</div>
		</div>
		<!-- end theme-panel -->
