...
class dmha_292 extends Model
{
    ...
    public static function let_me_generate_data_array($AUTH_ID,$ID)
    {
        ...
        // ------------------------------------------------------------------------- ACTION
            $isi = dmha_292::whereNull('deleted_at')
                ->orderBy('id','asc')
                ->get();
