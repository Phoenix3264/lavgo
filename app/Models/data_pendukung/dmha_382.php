...
class dmha_382 extends Model
{
    ...
    public static function let_me_generate_data_array($AUTH_ID,$ID)
    {
        ...
        // ------------------------------------------------------------------------- ACTION
            $isi = dmha_382::whereNull('deleted_at')
                ->orderBy('nama','asc');
