...
class dmha_431 extends Model
{
    ...
    public static function let_me_generate_data_array($AUTH_ID,$ID)
    {
        ...
        // ------------------------------------------------------------------------- ACTION
            $isi = dmha_431::whereNull('deleted_at')
                ->orderBy('nama','asc');
    ...
    public static function update_me($id,$array_data)
    {
        ...
        // ------------------------------------------------------------------------- ACTION
            dmha_431::where('id','=', $id)
            ->update(
                [
                    'nama'     => $array_data['nama'],
                    'urutan'     => $array_data['urutan'],
                    'deskripsi'     => $array_data['deskripsi'],
                    'updated_at'     => now()
                ]);
