...
class dmha_167 extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['nik', 'nama', 'tempat_lahir', 'tanggal_lahir', 'jenis_kelamin', 'alamat', 'rt', 'rw', 'kabupaten_kota', 'kecamatan', 'desa_kelurahan', 'agama', 'status_perkawinan', 'pekerjaan', 'kewarganegaraan', 'nomor_telepon', 'status_dalam_keluarga', 'created_at', 'updated_at', 'deleted_at'];
